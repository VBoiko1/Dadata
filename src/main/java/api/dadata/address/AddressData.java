...
public class AddressData {
    ...
    private String house_flat_count;
    ...
    private String room_fias_id;
    private String room_cadnum;
    private String room_type;
    private String room_type_full;
    private String room;
    ...
    private ArrayList<String> history_values;
